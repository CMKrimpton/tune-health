  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-2': ['clamp(2rem, 1.5rem + 3vw, 3.5rem)', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
      ...
      animation: {
        ...
        'slide-in': 'slideIn 0.625s ease-out forwards',
        'scale-in': 'scaleIn 0.5s ease-out forwards',
        'text-reveal': 'textReveal 1.25s ease-out forwards',
